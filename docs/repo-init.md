...
| `scripts/install-user-skills.sh` | 安装 `skills/user/` 到用户级工具配置；从 [ima agent-interface](https://ima.qq.com/agent-interface) 安装 `ima-skill` 并提示 `~/.config/ima/` 凭证 | 修改后运行 `bash -n scripts/*.sh` |
